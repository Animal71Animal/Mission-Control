...
export const modules: Module[] = [
  ...
  { href: "/tips", icon: "💰", title: "Tips", desc: "Club tip tracking — Spearmint Rhino and The Torch, with comparison view.", status: "active", group: "business", children: [
    { href: "/torch-tips", icon: "🕯️", title: "Torch Tips", desc: "The Torch tip tracking — monthly totals, top tippers, dancer stats.", status: "active", group: "business" },
    ...
    { href: "/tips-comparison", icon: "📊", title: "Tips Comparison", desc: "SRB vs The Torch — side-by-side club tip performance and dancer rankings.", status: "active", group: "business" },
  ] },
