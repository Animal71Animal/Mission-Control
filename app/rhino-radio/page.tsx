  ...
  return (
    <div>
      ...
      >
        ...
        <Link href="/promotional-ideas" style={{ fontSize: "0.85rem", color: "var(--muted)", textDecoration: "none", marginTop: 8, display: "inline-block" }}>← Back to Promotional Ideas</Link>
      </div>
