...
export default function Page() {
  const md = fs.readFileSync("/home/ubuntu/business/dj-software/PRODUCT-BRIEF.md", "utf8");
  const html = marked(md) as string;
  return (
    <div style={{ maxWidth: 860 }}>
      <div style={{ marginBottom: 24 }}>
        <Link href="/wlp" style={{ color: "var(--muted)", fontSize: "0.85rem", textDecoration: "none" }}>← Back to WLP Business</Link>
        <h1 style={{ fontSize: "1.5rem", fontWeight: 700, marginTop: 12, color: "var(--text)" }}>📋 Product Brief</h1>
      </div>
