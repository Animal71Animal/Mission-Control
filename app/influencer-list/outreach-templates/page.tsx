...
We're launching something new Saturdays at Spearmint Rhino starting June 6th — think high-energy late-night party with amazing music, food, and entertainment. Our whole angle is creating a space where everyone feels welcome.
...
We're launching a new Saturday late-night experience at Spearmint Rhino (Boise) starting June 6th. The vibe: high-energy music, entertainment, and food — a genuine party destination for people looking for something to do when everywhere else closes.
...
[Phone]`,
  },
  {
    ...
    icon: "💬",
    category: "Comment",
    content: `Love this energy! 🔥 We're launching something similar Saturdays at Spearmint Rhino starting June 6th — high-energy late-night parties with amazing music and food. Would love to have you check it out + bring friends. DM us? We'd hook you up.`,
  },
  {
    id: "followup-1",
    ...
    <div>
      ...
      <div style={{ marginBottom: 28 }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <Link href="/influencer-list" style={{ fontSize: "0.85rem", color: "var(--muted)", textDecoration: "none" }}>← Back</Link>
        </div>
