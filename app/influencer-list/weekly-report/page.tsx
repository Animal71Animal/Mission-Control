  ...
  return (
    <div>
      ...
      <div style={{ background: "var(--card)", border: "1px solid rgba(201,168,76,0.3)", borderRadius: 12, padding: 24, marginBottom: 24 }}>
        <h2 style={{ fontSize: "1rem", fontWeight: 600, margin: "0 0 12px", color: "#e8d5b0" }}>📋 Summary for Bryan</h2>
        <textarea value={summary} onChange={(e) => setSummary(e.target.value)} rows={3} placeholder="1-2 sentence recap for Bryan..." style={{ width: "100%", padding: "10px", background: "var(--bg)", border: "1px solid var(--border)", borderRadius: 6, color: "var(--text)", fontSize: "0.9rem", resize: "vertical" }} />
      </div>
