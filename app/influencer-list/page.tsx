  ...
  return (
    <div>
      ...
      <div style={{ background: "var(--card)", border: "1px solid var(--border)", borderRadius: 12, padding: 24, marginBottom: 24 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: 12 }}>
          <div style={{ background: "rgba(155,93,229,0.1)", borderRadius: 8, padding: 16, textAlign: "center" }}>
            <div style={{ fontSize: "2rem", fontWeight: 700, color: "var(--accent2)" }}>June 6</div>
          ...
          <div style={{ background: "rgba(0,200,124,0.1)", borderRadius: 8, padding: 16, textAlign: "center" }}>
            <div style={{ fontSize: "2rem", fontWeight: 700, color: "#00c87c" }}>20-30</div>
            <div style={{ fontSize: "0.8rem", color: "var(--muted)" }}>Target Influencers</div>
          </div>
          <div style={{ background: "rgba(201,168,76,0.1)", borderRadius: 8, padding: 16, textAlign: "center" }}>
            <div style={{ fontSize: "2rem", fontWeight: 700, color: "#e8d5b0" }}>50-100</div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 16 }}>
        <Link
          href="/influencer-list/master-list"
          style={{ display: "block", padding: 24, borderRadius: 12, border: "1px solid var(--border)", background: "var(--card)", textDecoration: "none", color: "inherit", transition: "all 0.2s" }}
        >
        ...
        <Link
          href="/influencer-list/outreach-templates"
          style={{ display: "block", padding: 24, borderRadius: 12, border: "1px solid var(--border)", background: "var(--card)", textDecoration: "none", color: "inherit", transition: "all 0.2s" }}
        >
          <div style={{ fontSize: "2rem", marginBottom: 12 }}>📝</div>
        ...
        <Link
          href="/influencer-list/tracking-dashboard"
          style={{ display: "block", padding: 24, borderRadius: 12, border: "1px solid var(--border)", background: "var(--card)", textDecoration: "none", color: "inherit", transition: "all 0.2s" }}
        >
          <div style={{ fontSize: "2rem", marginBottom: 12 }}>📊</div>
        ...
        <Link
          href="/influencer-list/weekly-report"
          style={{ display: "block", padding: 24, borderRadius: 12, border: "1px solid var(--border)", background: "var(--card)", textDecoration: "none", color: "inherit", transition: "all 0.2s" }}
        >
          <div style={{ fontSize: "2rem", marginBottom: 12 }}>📝</div>
      ...
      <div style={{ background: "var(--card)", border: "1px solid var(--border)", borderRadius: 12, padding: 24, marginTop: 24 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
          <div>
            <h3 style={{ fontSize: "0.85rem", fontWeight: 600, color: "#00c87c", margin: "0 0 8px" }}>Must Have</h3>
          ...
          <div>
            <h3 style={{ fontSize: "0.85rem", fontWeight: 600, color: "#e8d5b0", margin: "0 0 8px" }}>Nice to Have</h3>
            <ul style={{ margin: 0, paddingLeft: 20, fontSize: "0.85rem", color: "var(--muted)", lineHeight: 1.8 }}>
              <li>Existing SRB followers</li>
